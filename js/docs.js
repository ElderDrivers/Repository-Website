...
function initSidenavHeightResize() {
    ...
    $("#resize-packages-nav").resizable({
        ...
        resize: function (event, ui) {
            resizeNav();
        }, /* resize the nav while dragging */
        stop: function (event, ui) {
            saveNavPanels();
        } /* once stopped, save the sizes to cookie  */
    });
    ...
    if (children_data != null) {
        ...
        node.expand_toggle.onclick = function () {
            if (node.expanded) {
                ...
                node.plus_img.src = me.toroot + "images/triangle-closed-small.png";
                node.expanded = false;
            } else {
                expand_node(me, node);
            }
...
function expand_node(me, node) {
    if (node.children_data && !node.expanded) {
        ...
        node.plus_img.src = me.toroot + "images/triangle-opened-small.png";
        node.expanded = true;
...
function toggleInherited(linkObj, expand) {
    ...
    if ((expand == null && a.hasClass("closed")) || expand) {
        ...
        trigger.src = toRoot + "images/triangle-opened.png";
        a.removeClass("closed");
        a.addClass("opened");
    } else if ((expand == null && a.hasClass("opened")) || (expand == false)) {
        list.style.display = "block";
        summary.style.display = "none";
        trigger.src = toRoot + "images/triangle-closed.png";
        ...
        for (var i = 0; i < expressions.length; i++) {
            ...
            switch (firstClause.attr) {
                ...
                case 'collection':
                    ...
                    resources = urls.map(function (url) {
                        return ALL_RESOURCES_BY_URL[url];
                    });
                    break;
                case 'section':
  ...
  */
    ...
    $.fn.decorateResourceCard = function (resource, plusone) {
        ...
        var imgUrl = resource.image ||
            'images/resource-card-default-android.jpg';
    ...
    function initWidget(widget) {
        ...
        function transitionWidget($toTab) {
            if (!$curTab.is($toTab)) {
                ...
                $highlight.animate({
                    left: $($li[toIndex]).position().left + 'px',
...
(function ($) {
    ...
    $.fn.dacCarouselQuery = function () {
        return this.each(function () {
            ...
            if (!data) {
                el.data('dac.carouselQuery', (data = new DacCarouselQuery(el)));
            }
        });
    };
...
(function ($) {
    ...
    DacCarousel.prototype.initPagination = function () {
        ...
        var parent = this.el;
        if (typeof this.options.pagination === 'string') {
            parent = this.el.find(this.options.pagination);
        }
    ...
    DacCarousel.prototype.startRotateTimer = function () {
        if (!this.options.auto || this.rotateTimer) {
            return;
        }
    ...
    DacCarousel.prototype.go = function (next) {
        ...
        while (this.count > 0 && next >= this.count) {
            next -= this.count;
        }
        while (next < 0) {
            next += this.count;
...
(function ($) {
    ...
    function ToggleNav(el, options) {
        ...
        if (this.options.body) {
            this.options.target.push('body')
        }
        if (this.options.dimmer) {
            this.options.target.push(this.options.dimmer)
        }
...
(function ($) {
    ...
    $.fn.toggleSection = function (option) {
        return this.each(function () {
            ...
            if (!data) {
                $this.data('dac.togglesection', (data = new Toggle(this)));
            }
